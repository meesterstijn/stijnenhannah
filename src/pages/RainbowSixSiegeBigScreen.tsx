 ...
 *
 * Gebruikt Supabase Realtime (niet alleen React Query optimistic updates)
 * omdat dit scherm op een ANDER apparaat/browservenster open staat dan de
 * tablet waarmee acties geregistreerd worden — er is geen gedeelde
 * in-memory cache tussen die twee. Belangrijk: Realtime-replicatie moet
 * voor r6_events/r6_matches/r6_sessions/r6_game_operator_assignments/
 * r6_session_chaos_effects wél aanstaan in het Supabase-dashboard (Database
 * -> Replication) — dat is geen instelling die vanuit code aangezet kan
 * worden.
 */
