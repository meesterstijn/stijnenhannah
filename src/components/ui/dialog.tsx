...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      <div className="overflow-y-auto scrollbar-none p-6 flex flex-col gap-4">
        {children}
      </div>
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 h-8 w-8 rounded-md border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
