...
export function WizardStepPublish({
  ...
  return (
    <div className="space-y-3 text-sm">
      ...
      <p>
        <span className="cb-muted">2e variant:</span>{" "}
        {state.hasVariant2 ? "Ja" : "Nee"}
      </p>
      <p>
        <span className="cb-muted">Alcoholvrije variant:</span>{" "}
        {state.hasAlcoholFree ? "Ja" : "Nee"}
      </p>
      <p className="cb-muted">
        Kies hieronder "Concept opslaan" om later verder te werken, of
        "Publiceren" om de cocktail direct zichtbaar te maken op de Cocktail
        Bar-pagina.
      </p>
    </div>
  );
